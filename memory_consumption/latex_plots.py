...
\\toprule
\\multicolumn{{{no_info_columns}}}{{c}}{{}} & \\multicolumn{{{no_algo_columns}}}{{c}}{{Internal structure memory consumption in Megabyte}} \\\\
...
def complete_algorithms(pdata, algs):
    ...
    for i in range(len(datasets)):
      ...
      for j in range(len(no_clusters_list)):
        ...
        algorithms, mem_cons, stddevs, durations = get_plot_data(pdata[dataset]['results'][no_clusters])
